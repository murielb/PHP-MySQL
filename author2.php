...
<body>
		...
		<tr>
			...
			while($row = mysqli_fetch_array($result)){
				...
				<tr>
					...
					<td>
						<form action="process_delete_author2.php" method="post" onsubmit="if(!confirm('Are you sure?')){return false;}">
	...
	$form_action = 'process_create_author2.php';
	$form_id = '';
	if(isset($_GET['id'])){
		...
		$form_action = 'process_update_author2.php';
